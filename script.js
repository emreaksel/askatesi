        //merhabalar :)
        konsola_yaz("Debug", ' Denemeler: ' + 110);
        ...
        function mixTrack() {
            ...
            if (next_type == 0) {
                next_type = 1;
                $('#random').html('<span class="glyphicon glyphicon-sort-by-attributes-alt" aria-hidden="true"></span>');
            }
            else if (next_type == 1) {
                next_type = 2;
                $('#random').html('<span class="glyphicon glyphicon-retweet" aria-hidden="true"></span>');
            }
            else if (next_type == 2) {
                next_type = 0;
                $('#random').html('<span class="glyphicon glyphicon-random" aria-hidden="true"></span>');
            }
        ...
        function loadTrack(track_indexxx) {
            ...
            $(".track-artist").text(track_list[track_indexxx].artist.replace(':', ''));
